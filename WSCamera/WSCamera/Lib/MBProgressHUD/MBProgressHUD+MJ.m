...
{
    [self show:error icon:@"error.png" view:view andDelay:delay];
}

+ (void)showSuccess:(NSString *)success toView:(UIView *)view andDelay:(float)delay
{
    [self show:success icon:@"success.png" view:view andDelay:delay];
}

+ (void)showSuccess:(NSString *)success andDelay:(float)delay
{
    [self showSuccess:success toView:nil andDelay:delay];
}

+ (void)showError:(NSString *)error andDelay:(float)delay
{
    [self showError:error toView:nil andDelay:delay];
}
